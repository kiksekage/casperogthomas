...
def train_random_forest(train_features, train_labels):
    random_forest = RandomForestRegressor(random_state=random_state, n_estimators=20)
...
def train_random_forest_class(train_features, train_labels):
    random_forest_class = RandomForestClassifier(random_state=random_state, n_estimators=20)
